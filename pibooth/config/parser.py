...
DEFAULT = odict((
    ...
    ("WINDOW",
        odict((
            ...
            ("arrows",
                ('bottom',
                 "Show on-screen guidance near the controls: 'bottom', 'top', 'hidden' or 'touchscreen'",
                 "Show control hints", ['bottom', 'top', 'hidden', 'touchscreen'])),
            ("arrows_x_offset",
                (0,
    ...
    ("CAMERA",
        odict((
            ...
            ("preview_resolution",
                ((),
                 "Resolution for the camera preview (leave empty to match capture resolution)",
                 None, None)),
