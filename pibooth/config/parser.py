...
DEFAULT = odict((
    ...
    ("WINDOW",
        odict((
            ...
            ("hardware_acceleration",
                ('auto',
                 "Hardware acceleration backend for the window: 'auto', 'opengl' or 'off'",
                 "Hardware acceleration", ['auto', 'opengl', 'off'])),
            ("animate_delay",
                (0.2,
    ...
    ("PICTURE",
        odict((
            ...
            ("opencl",
                (False,
                 "Enable OpenCL acceleration for picture compositing when supported",
                 "Picture OpenCL", ['True', 'False'])),
        ))
     ),
    ("CAMERA",
        odict((
            ...
            ("opencl",
                (True,
                 "Enable OpenCL when using the OpenCV camera backend",
                 "Camera OpenCL", ['True', 'False'])),
        ))
     ),
    ("PRINTER",
        odict((
